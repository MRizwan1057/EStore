$(function () {
  ...
  $(".myNav").on("click", ".btn-addCart", fgfgf);
});
...
function getProducts(product) {
  ...
  for (var i = 0; i < product.length; i++) {
    $(".myNav").append(`<div class="card-deck text-center">
      <div class="card border-secondary">
        <span class="bg-warning">-54%</span><br /><img
          src="./images/usb.png"
          alt=""
          class="card-image"
        />
        ...
        <div class="card-body text-center product-div">
          <h4 class="card-title text-center">${product[i].name}</h4>
          <h5 class="card-text">${product[i].price} PKR</h5>
          <h6 class="bg-white">${product[i].soldQty} Sold</h6>
          <br />
          <span class="fa fa-star checked"></span>
          <span class="fa fa-star checked"></span>
          <span class="fa fa-star checked"></span>
          <span class="fa fa-star"></span>
          <span class="fa fa-star"></span> <br /><br /><button
            class="btn btn-outline-warning text-primary"
          >
            Order Now</button
          ><button
            class="btn btn-outline-danger btn-addCart"
            type="button"
            data_id="${product[i]._id}"
          >
            Add to Cart
          </button>
          <h5>${product[i]._id}</h5>
